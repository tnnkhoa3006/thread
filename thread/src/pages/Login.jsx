                ...
                <div className="w-full pt-[30px] flex flex-col justify-center items-center space-y-[20px]">
                  <form className='w-full' action="">
                    <div className="w-full flex justify-center items-center pb-[10px]">
                      <input className="text-xs w-3/4 h-[35px] text-white outline-none resize-none bg-zinc-900 rounded-sm border-[1px] border-gray-500 px-3" type="text" placeholder="Phone number, username, or email" />
                    </div>
                    <div className="w-full flex justify-center items-center">
                      <input className="text-xs w-3/4 h-[35px] text-white outline-none resize-none bg-zinc-900 rounded-sm border-[1px] border-gray-500 px-3" type="password" placeholder="Password" />
                    </div>
                    <div className="w-full flex justify-center items-center pt-[15px]">
                      <button className="w-3/4 h-[30px] text-gray-300 bg-blue-700 rounded-lg border-[1px] border-gray-500">Log in</button>
                    </div>
